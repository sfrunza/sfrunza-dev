...
function SocialLink({
  ...
  return (
    <li className={clsx(className, 'flex')}>
      <Link
        href={href}
        className="group flex text-sm font-medium transition hover:text-primary items-center"
      >
...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I&apos;m Sergiu Frunza. I live in Boston MA, where I design the future.',
  alternates: {
    canonical: {
        ...
        <div className="lg:pl-20">
          <div className="max-w-xs px-2.5 lg:max-w-none">
            <Image
              ...
              className="aspect-square rotate-3 rounded-2xl bg-background object-cover"
            />
          </div>
        </div>
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
            I&apos;m Sergiu Frunza. I live in Boston MA, where I design the
            future.
          </h1>
          <div className="mt-6 space-y-7 text-base text-muted-foreground">
            ...
            <p>
              ...
              sent my dad&apos;s Blackberry into orbit and was able to transmit
